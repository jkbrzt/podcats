...
class Channel(object):
    ...
    def __init__(self, root_dir, root_url, host, port, title, link, debug=False, feed_base_url=None):
        ...
        self.debug = debug
        self.feed_base_url = feed_base_url or root_url
        ...
        for root, _, files in os.walk(self.root_dir):
            ...
            for fn in files:
                ...
                if mimetype and 'audio' in mimetype or filepath.endswith('m4b'):
                    yield Episode(filepath, relative_dir, self.feed_base_url)
...
parser.add_argument(
    '--feed-base-url',
    help='feed base URL to use in the RSS feed and file links (e.g. https://mydomain.com)'
)
parser.add_argument(
    'action',
    metavar='COMMAND',
